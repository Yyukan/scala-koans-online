          ...
          angular
                  ...
                  .value(
                          ...
                          (function() {
                            ...
                            [0, 1, 2, 3, 4, 5]
                                    .forEach(function(red) {
                                      return [0, 1, 2, 3, 4, 5]
                                              .forEach(function(green) {
                                                return [0, 1, 2, 3, 4, 5]
                                                        .forEach(function(blue) {
                                                          var b, c, g, n, r, rgb;
                                                          c = 16 + (red * 36)
                                                                  + (green * 6)
                                                                  + blue;
                              ...
                              return _results;
                                    ...
                                    .forEach(
                                            function(gray) {
                                              ...
                                              STYLES["ef" + c] = "color:#" + l
                                                      + l + l;
                                              return STYLES["eb" + c] = "background-color:#"
                                                      + l + l + l;
                                            });

                            extend = function() {
                              var dest, k, obj, objs, v, _j, _len;
                              dest = arguments[0], objs = 2 <= arguments.length
                            ...
                            Filter = (function() {
                              ...
                              Filter.prototype.forEach = function(callback) {
                                ...
                                handleDisplay = function(code) {
                                  ...
                                  if ((29 < code && code < 38)) {
                                    callback(_this
                                            .pushStyle("ef" + (code - 30)));
                                  }
                                  if (code === 39) {
                                    callback(_this.pushStyle("color:"
                                            + _this.opts.fg));
                                  }
                                  if ((39 < code && code < 48)) {
                                    callback(_this
                                            .pushStyle("eb" + (code - 40)));
                                  }
                                  if (code === 49) {
                                    callback(_this
                                            .pushStyle("background-color:"
                                                    + _this.opts.bg));
                                  }
                                  if ((89 < code && code < 98)) {
                                    callback(_this.pushStyle("ef"
                                            + (8 + (code - 90))));
                                  }
                                  if ((99 < code && code < 108)) { return callback(_this
                                          .pushStyle("eb" + (8 + (code - 100)))); }
                                };

                                this.input.forEach(function(chunk) {
                                  buf += chunk;
                                  return _this.tokenize(buf,
                                          function(tok, data) {
                                            switch (tok) {
                                            case 'text':
                                ...
                                if (this.stack.length) { return callback(this
                                        .resetStyles()); }
                              };
                              ...
                              Filter.prototype.closeTag = function(style) {
                                ...
                                if (last != null) { return "</" + style + ">"; }
                              };

                              Filter.prototype.resetStyles = function() {
                                var stack, _ref;
                                _ref = [this.stack, []], stack = _ref[0],
                                        this.stack = _ref[1];
                              ...
                              Filter.prototype.tokenize = function(text,
                                      callback) {
                                ...
                                process = function(handler, i) {
                                  ...
                                  text = text.replace(handler.pattern,
                                          handler.sub);
                                  if (!(matches != null)) {
